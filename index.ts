...
const main = async () => {
  while (true) {
    ...
    await quiz(
      ...
      ["K2", "Kilimanjaro", questionAns.q1],
      questionAns.q1
    );
    await quiz(
      "Which is the largest ocean in the world?",
      ["Atlantic Ocean", questionAns.q2, "Indian Ocean"],
      questionAns.q2
    );
    await quiz(
      "What is the name of the famous painting by Leonardo da Vinci?",
      [questionAns.q3, "Starry Night", "The Scream"],
      questionAns.q3
    );
    await quiz(
      "Who was the first person to step on the moon?",
      ["Buzz Aldrin", "Michael Collins", questionAns.q4],
      questionAns.q4
    );
    await quiz(
      "Who wrote plays like ‘Romeo and Juliet’ and ‘Hamlet’?",
      ["Charles Dickens", questionAns.q5, "Jane Austen"],
      questionAns.q5
    );
